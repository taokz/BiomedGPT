...
log_dir=./peir_gross_stage1_logs
save_dir=../../checkpoints/tuned_checkpoints/peir_gross/tiny/stage1_checkpoints
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../module

data_dir=../../datasets/finetuning/peir_gross
data=${data_dir}/peir_gross_train.tsv,${data_dir}/peir_gross_val.tsv
...
eval_cider_cached=../../datasets/finetuning/word_freq/peir-gross-valid-words.p
...
for max_epoch in {100,}; do
  ...
  for warmup_ratio in {0.06,}; do
    ...
    for drop_worst_after in {600,}; do
      ...
      CUDA_VISIBLE_DEVICES=8,9 python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=${MASTER_PORT} ../../../train.py \
          $data \
